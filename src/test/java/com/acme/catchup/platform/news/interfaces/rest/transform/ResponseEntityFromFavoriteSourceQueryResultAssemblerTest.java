...
class ResponseEntityFromFavoriteSourceQueryResultAssemblerTest {
    ...
    void convertsFavoriteSourceToOkResponseEntity() {
        ...
        var favoriteSource = FavoriteSource.create(command.newsApiKey(), command.sourceId());
    ...
    void convertsFavoriteSourceListToOkResponseEntity() {
        var first = FavoriteSource.create(new NewsApiKey("key-one"), new SourceId("source-one"));
        var second = FavoriteSource.create(new NewsApiKey("key-two"), new SourceId("source-two"));
